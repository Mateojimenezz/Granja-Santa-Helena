...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // 🌟 Agregar el botón dentro de la lista de granjas
    const botonAgregar = document.createElement("div");
    botonAgregar.classList.add("col-md-auto");
    botonAgregar.innerHTML = `<button id="agregar-granja" class="btn btn-primary btn-lg">+ Agregar Nueva Granja</button>`;
