...
document.addEventListener("DOMContentLoaded", function () {
  ...
  toggleMenu.addEventListener("click", function () {
    if (sidebar.style.display === "none" || sidebar.style.display === "") {
      ...
      sidebar.style.zIndex = "9999"; // Asegura que el menú lateral esté sobre otros elementos
      sidebar.style.height = "100%"; // Ajusta altura completa
      mainContent.style.marginLeft = "270px"; // Desplaza el contenido principal
      mainContent.style.maxWidth = `calc(100% - 270px)`; // Ajusta el ancho dinámicamente
      mainContent.style.overflowX = "hidden"; // Elimina scroll horizontal
      mainContent.style.boxSizing = "border-box"; // Considera paddings y bordes
