  ...
  function adjustMainContent() {
    if (sidebar.style.display === "none") {
      ...
      if (iframeContent) {
        ...
        iframeContent.style.margin = "10px"; // Elimina el margen
        iframeContent.style.height = "100vh"; // Ajusta la altura del iframe

      }
    } else {
      mainContent.style.marginLeft = "200px"; // Ajusta el margen izquierdo
