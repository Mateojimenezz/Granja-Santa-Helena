 ...
 deleteUserButton.addEventListener('click', function () {
  ...
  printButton.addEventListener('click', function () {
    ...
    doc.autoTable({
      head: [['Seleccionar', 'Seleccionar', 'Fecha', 'Lote', 'Categoría', 'Tipo de Alimento', 'Cantidad de Salida', 'Destino', 'Responsable']], // Encabezados', 'Rol', 'Asignar Permisos']], // Encabezados
