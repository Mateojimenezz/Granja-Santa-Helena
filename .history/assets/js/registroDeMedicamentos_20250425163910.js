document.addEventListener('change', function (event) {
 ...
 deleteUserButton.addEventListener('click', function () {
  ...
  document.getElementById('exportExcelButton').addEventListener('click', function (event) {
    ...
    worksheetData.push(['Seleccionar', 'N-Medicamento', 'Cantidad', 'Fecha de Entrada', 'Fecha de Salida', 'Proveedor', 'Lote', 'Fecha de Vencimiento', 'Responsable', '', 'Fecha de Entrada', 'Fecha de Salida', 'Proveedor', 'Lote', 'Estado', 'Responsable']);
