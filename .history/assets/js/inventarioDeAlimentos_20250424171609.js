...
function filtrarTabla() {
  ...
  const filas = document.querySelectorAll('#userTable tbody tr'); // Todas las filas de la tabla

  filas.forEach(fila => {
    const textoFila = fila.innerText.toLowerCase().trim(); // Texto visible en la fila
    console.log('Texto de la fila:', textoFila); // Ver texto de la fila
    console.log('Filtro:', filtro); // Ver el texto ingresado en la barra
