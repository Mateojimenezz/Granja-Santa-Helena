  ...
  function cargarUsuarios() {
    usuarios.forEach(usuario => {
      ...
      row.innerHTML = `
        ...
        <td>
          <button class="btn ${usuario.estado === 'Activo' ? 'btn-danger' : 'btn-success'} btn-sm">${usuario.estado === 'Activo' ? 'Bloquear' : 'Activar'}</button>
          <button class="btn btn-primary btn-sm actualizar-usuario">Actualizar</button>
        </td>
      `;
