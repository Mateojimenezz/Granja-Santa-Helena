...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function showSubmenuInSidebar(item) {
    ...
    sidebar.style.zIndex = "3"; // Garantiza que esté sobre otros elementos
    sidebar.style.top = "0";
    sidebar.style.bottom = "150px";
    sidebar.style.height = "100%";
    
    const logoutButton = document.querySelector(".logout-button");
    logoutButton.style.zIndex = "0"; // Asegura que el botón quede debajo
    if (isLargeScreen()) {
