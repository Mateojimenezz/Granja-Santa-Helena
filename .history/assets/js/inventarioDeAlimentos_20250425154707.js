...
document.addEventListener('change', function (event) {
   ...
   newRow.innerHTML = `
            <td>
              ...
              <td>
                 ...
                 <select id="categoria" name="categoria" class="form-select form-select-categoria" title="Seleccione una categoría">
              ...
              <td>
                ...
                <select id="tipo" name="tipo" class="form-select form-select-tipo" title="Seleccione un tipo de alimento">
              ...
              <td>
                <!-- Selector de Lote -->
                <select id="lote" name="lote" class="form-select">
                  <option selected disabled>Seleccionar</option> <!-- Opción predeterminada -->
 ...
 deleteUserButton.addEventListener('click', function () {
  ...
  //----------------------------------------------------------------------------------------
// Función para imprimir la tabla en formato PDF
...
//---------------------------------------------------------------------------------------
  ...
  document.getElementById('exportExcelButton').addEventListener('click', function (event) {
    event.preventDefault(); // Evitar comportamiento predeterminado del <a>
    ...
    worksheetData.push(['Seleccionar', 'Categoría', 'Tipo de Alimentos', 'Cantidad', 'Fecha de Entrega', 'Proveedor', 'Lote', 'Fecha de Vencimiento']);

    // Recorrer las filas y agregar los datos al worksheet
    rows.forEach(row => {
        const rowData = Array.from(row.cells).map(cell => {
            const input = cell.querySelector('input, select');
            return input ? (input.type === 'checkbox' ? (input.checked ? 'off' : 'on') : input.value || input.options[input.selectedIndex]?.text) : cell.textContent.trim();
        });
