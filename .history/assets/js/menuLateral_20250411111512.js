...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function adjustMainContent() {
    if (sidebar.style.display === "none") {
      container.style.marginLeft = "200px"; // Elimina el margen izquierdo
      container.style.width = "100%"; // Ancho completo
      if (iframeContent) {
        iframeContent.style.width = "100vw"; // Ajusta el iframe
      }
    } else {
      container.style.marginLeft = "250px"; // Ajusta el margen izquierdo
      container.style.marginTop = "-30px"; // Ajusta el margen superior
