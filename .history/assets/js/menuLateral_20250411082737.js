...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function adjustMainContent() {
    if (sidebar.style.display === "none") {
      ...
      mainContent.style.marginRight = "-100px"; // Elimina el margen izquierdo

      mainContent.style.width = "100%"; // Ancho completo

      if (iframeContent) {
        iframeContent.style.width = "100%"; // Ajusta el iframe
        iframeContent.style.height = "100%"; // Ajusta la altura del iframe
