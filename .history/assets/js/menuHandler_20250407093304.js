...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function showSubmenuInSidebar(item) {
    ...
    if (isLargeScreen()) {
      mainContent.style.marginLeft = "250px"; // Desplaza el contenido en pantallas grandes
    } else {
  ...
  window.addEventListener("resize", function () {
    if (isLargeScreen()) {
      ...
      mainContent.style.marginLeft = "250px"; // Ajusta el margen dinámicamente para evitar que quede oculto
    } else {
