...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // 🌟 Agregar manualmente la primera granja fija
    const primeraGranja = document.createElement("div");
    primeraGranja.classList.add("col-md-3");

    primeraGranja.innerHTML = `
        <div class="card shadow-sm">
            <img src="./assets/img/granja2.jpg" class="card-img-top" alt="Santa Helena">
            <div class="card-body text-center">
                <h5 class="card-title">Granja Santa Helena</h5>
                <button class="btn btn-form" onclick="seleccionarGranja('Santa Helena')">Seleccionar</button>
            </div>
        </div>
    `;

    listaGranjas.appendChild(primeraGranja);

    // 🌟 Agregar las granjas dinámicamente después de la fija
