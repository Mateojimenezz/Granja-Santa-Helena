   ...
   newRow.innerHTML = `
    <td>
              ...
              <td>
                ...
                <td>
                    <input type="date" class="input-no-border form-control-fecha Fecha-vencimiento" placeholder="Fecha de vencimiento">
                </td>
                <td>
                  <span id="estado-medicamento" name="estado-medicamento" class="estado-medicamento"></span>
                </td>
