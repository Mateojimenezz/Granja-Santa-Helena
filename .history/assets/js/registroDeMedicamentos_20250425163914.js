document.addEventListener('change', function (event) {
 ...
 addUserButton.addEventListener('click', function () {
   ...
   newRow.innerHTML = `
          <td>
              ...
              <td>
                <input type="text" class="input-no-border" placeholder="Nombre del Medicamento" />
                </td>
              <td>
 ...
 deleteUserButton.addEventListener('click', function () {
  ...
  document.getElementById('exportExcelButton').addEventListener('click', function (event) {
    ...
    worksheetData.push(['Seleccionar', 'N-Medicamento', 'Cantidad', 'Fecha de Entrada', 'Fecha de Salida', 'Proveedor', 'Lote', 'Fecha de Vencimiento', 'Responsable', 'Solicitante', 'Fecha de Entrada', 'Fecha de Salida', 'Proveedor', 'Lote', 'Estado', 'Responsable']);
