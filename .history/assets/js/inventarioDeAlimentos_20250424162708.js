...
function filtrarTabla() {
  const filtro = document.getElementById('busqueda').value.toLowerCase(); // Convertir el texto ingresado a minúsculas
  const filas = document.querySelectorAll('#userTable tbody tr'); // Seleccionar todas las filas dentro de la tabla

  filas.forEach(fila => {
    const textoFila = fila.textContent.toLowerCase(); // Convertir el texto de cada fila a minúsculas
...
// Evento para la barra de búsqueda al escribir
