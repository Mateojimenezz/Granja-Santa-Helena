  ...
  function cargarUsuarios() {
    usuarios.forEach(usuario => {
      ...
      row.innerHTML = `
        ...
        <td>
          <a class="btn-agregar-usuario  ${usuario.estado === 'Activo' ? 'btn-danger' : 'btn-success'} ">${usuario.estado === 'Activo' ? 'Bloquear' : 'Activar'}</a>
          <a class=" btn-agregar-usuario ">Actualizar</a>
        </td>
      `;
