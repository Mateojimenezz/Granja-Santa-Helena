/* aqui se manejan parte del submenu sub-submenu del menu lateral y header en pantalla grande y pequeña */
document.addEventListener("DOMContentLoaded", function () {
  ...
  const sidebarMenu = document.getElementById("sisidebarMenu"); // Contenedor del menú lateral
     ...
     if (!toggleMenu || !closeMenu || !sidebar || !mainContent || !sidebarMenu) {
      console.error("Uno o más elementos necesarios no existen en el DOM.");
      return; // Detén la ejecución si faltan elementos
    }
  ...
  function showSubmenusInSidebar() {
      ...
      if (submenu) {
        ...
        subSubmenus.forEach(subSubmenu => {
          ...
          parentLink.addEventListener("click", function (e) {
            ...
            // Forzar visibilidad directamente
    ...
    mainContent.style.marginLeft = "200px"; // Desplaza el contenido en pantallas grandes
  }
