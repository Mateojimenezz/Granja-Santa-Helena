...
function showSubmenuInSidebar(item) {
  ...
  if (isLargeScreen()) {
    ...
    container.style.maxWidth = `calc(100vw- ${sidebar.offsetWidth}px)`; // Reduce el ancho según el sidebar
  ...
  window.addEventListener("resize", function () {
    if (isLargeScreen()) {
      ...
      container.style.marginLeft = "0px"; // Asegura que el contenido no se desplace
    }
  });
