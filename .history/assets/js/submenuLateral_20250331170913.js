document.addEventListener("DOMContentLoaded", function () {
    ...
    function showSingleSubmenu(item) {
        ...
        if (submenu) {
          const clonedSubmenu = submenu.cloneNode(true);
          clonedSubmenu.classList.add("sidebar-submenu"); // Añade clase para el menú lateral
          clonedSubmenu.style.display = "block"; // Asegúrate de que esté visible
          // Luego realiza el resto de la lógica como en el Enfoque 1
        }
      }
