function imprimirFormulario() {
  ...
  // Transferir la imagen de la cerda
...
//----------------------------------------------------------------------------------------------------------------
function verificarArchivoTratamiento() {
  // Verificar si se adjuntó archivo en Registro de Tratamiento
  const registroTratamientoInput = document.getElementById('registroTratamiento');
  const resultadoArchivo = document.getElementById('archivoEstado');

  // Actualizar el estado según si hay archivo o no
  resultadoArchivo.innerText = registroTratamientoInput.files.length > 0 ? "Sí" : "No";
}
