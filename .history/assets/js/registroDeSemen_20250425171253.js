document.addEventListener('change', function (event) {
 ...
 deleteUserButton.addEventListener('click', function () {
  ...
  document.getElementById('exportExcelButton').addEventListener('click', function (event) {
    ...
    worksheetData.push(['Seleccionar', 'ID-Verraco', 'Fecha de Recolección', 'Cantidad', 'Fecha de Entrada', 'Fecha de Salida', 'Proveedor', 'Lote', 'Fecha de Vencimiento', 'Responsable', 'Solicitante']);
