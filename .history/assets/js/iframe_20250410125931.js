document.addEventListener("DOMContentLoaded", function () {
    ...
    menuItems.forEach(item => {
      item.addEventListener("click", function (e) {
        ...
        iframeContent.src = "C:\Users\USUARIO\OneDrive\Documentos\Granja-Santa-Helena\Gestion_de_permisos_roles.html"; // Cambia el src del iframe para cargar la página
      });
    });
  });
