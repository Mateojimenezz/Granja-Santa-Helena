...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function configureSidebarMenu() {
    ...
    const icons = [
      "bi bi-people",        // Ícono para el primer ítem (por ejemplo, Usuarios)
      "bi bi-box-seam",      // Ícono para el segundo ítem (por ejemplo, Inventarios)
      "bi bi-pencil-square", // Ícono para el tercer ítem (por ejemplo, Registro de Producción)
      "bi bi-heart-pulse",   // Ícono para el cuarto ítem (por ejemplo, Salud Animal)
      "bi bi-cash",          // Ícono para el quinto ítem (por ejemplo, Ventas)
    ];
