document.addEventListener("DOMContentLoaded", function () {
  ...
  // Limpia el contenido del menú lateral para evitar duplicados
  ...
  function showHeaderItemsInSidebar() {
    ...
    menuItems.forEach(item => {
      ...
      if (submenu) {
        ...
        // Añade funcionalidad para alternar el submenú
  ...
  // Mostrar u ocultar el menú lateral al hacer clic en el botón toggle
  toggleMenu.addEventListener("click", function () {
    if (sidebar.style.display === "none" || sidebar.style.display === "") {
      sidebar.style.display = "block"; // Muestra el menú lateral
      showHeaderItemsInSidebar(); // Asegúrate de que el menú lateral tenga los ítems del header
      if (isLargeScreen()) {
  ...
  function setupHeaderSubmenus() {
    ...
    menuItems.forEach(item => {
      ...
      if (submenu) {
        ...
        // Añadir funcionalidad para mostrar/ocultar submenú al hacer clic
        const link = item.querySelector(".nav-link");
