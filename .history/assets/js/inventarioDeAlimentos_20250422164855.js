 ...
 deleteUserButton.addEventListener('click', function () {
  ...
  printButton.addEventListener('click', function () {
    ...
    doc.autoTable({
      head: [[ 'Categoria', 'Tipo de Alimentos', 'Cantidad', 'Fecha de Entrega', 'Proveedor', 'Lote','Fecha de Vencimiento']], // Encabezados
    ...
    doc.save('Inventario_de_.pdf'); // Nombre del archivo
  });