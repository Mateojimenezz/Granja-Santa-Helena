 ...
 addUserButton.addEventListener('click', function () {
   ...
   newRow.innerHTML = `
             <td>
              ...
              <td>
                <input type="date" class="form-control fecha-recoleccion" placeholder="Fecha de Recolección">
              </td>
              <td>
              ...
              <td>
                <input type="date" class="form-control fecha-caducidad" placeholder="Fecha de caducidad">
              </td>
                <td>
                    <input type="date" class="form-control fecha-salida" placeholder="Fecha de salida">
              <td>
