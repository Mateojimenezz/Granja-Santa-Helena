...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const container= document.querySelector("main"); // Contenido principal
  ...
  function adjustMainContent() {
    if (sidebar.style.display === "none") {
      container.style.marginLeft = "0px"; // Elimina el margen izquierdo
      container.style.width = "100vw"; // Ancho completo
      if (iframeContent) {
        iframeContent.style.width = "100vw"; // Ajusta el iframe
      }
    } else {
      container.style.marginLeft = "250px"; // Ajusta el margen izquierdo
      container.style.marginTop = "-40px"; // Ajusta el margen superior
      container.style.width = `calc(100% - ${sidebar.offsetWidth}px)`; // Calcula el ancho dinámico
      if (iframeContent) {
        iframeContent.style.width = "100vw"; // Asegura que el iframe ocupe el ancho de mainContent
      }
    }
  }
