  ...
  function cargarUsuarios() {
    usuarios.forEach(usuario => {
      ...
      row.innerHTML = `
        ...
        <td>
          <a class="btn-agregar-usuario  ${usuario.estado === 'Activo' ? 'link-rojo' : 'link-verde'} ">${usuario.estado === 'Activo' ? 'Bloquear' : 'btn-success'} ">${usuario.estado === 'Activo' ? 'Bloquear' : 'Activar'}</a>
