...
document.addEventListener('change', function (event) {
 ...
 deleteUserButton.addEventListener('click', function () {
  ...
  function exportarExcel() {
    const tabla = document.getElementById('userTable'); // ID de tu tabla
    const wb = XLSX.utils.table_to_book(tabla); // Convierte la tabla a un libro de Excel
    const wbout = XLSX.write(wb, { bookType: 'xlsx', type: 'binary' }); // Escribe el libro en formato binario
    ...
    link.download = 'Inventario.xlsx'; // Nombre del archivo
    link.click();
  }
  ...
  // Llama a la función de exportación al hacer clic en un botón
