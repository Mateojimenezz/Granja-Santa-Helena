      ...
      if (submenu) {
        ...
        subSubmenus.forEach(subSubmenu => {
          ...
          if (parentItem) {
            const parentLink = parentItem.querySelector(".nav-link");
            if (parentLink) {
              console.log("Clic detectado en:", parentLink); // Depuración para confirmar que el elemento existe
            } else {
              console.warn("No se encontró .nav-link en parentItem:", parentItem);
            }
          } else {
            console.error("parentItem es nulo o indefinido");
          }
