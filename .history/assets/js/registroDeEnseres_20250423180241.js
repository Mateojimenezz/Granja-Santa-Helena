...
const categoriasYTipos = {
 ...
 deleteUserButton.addEventListener('click', function () {
  ...
  printButton.addEventListener('click', function () {
    ...
    doc.autoTable({
      head: [['Seleccionar', 'Nombres', 'Categoría', 'Ensere', 'Cantidad', 'Fecha de Entrada', 'Fecha de Salida', 'Proveedor', 'Lote', 'Categoría', 'Tipo de Alimento', 'Cantidad de Salida', 'Destino', 'Responsable']], // Encabezados
