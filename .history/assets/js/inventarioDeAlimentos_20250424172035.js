...
document.addEventListener('change', function (event) {
 ...
 deleteUserButton.addEventListener('click', function () {
  ...
  function filtrarTabla() {
    ...
    filas.forEach(fila => {
      // Extraer todo el texto visible de la fila
      const textoFila = fila.innerText.toLowerCase().trim(); 
  
      // Comparar el texto de la fila con el filtro
    ...
    if (!hayResultados) {
      console.log(`No se encontraron resultados para: "${filtro}"`); // Mensaje de depuración
    }
  }
