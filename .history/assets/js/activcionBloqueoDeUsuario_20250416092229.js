  ...
  function cargarUsuarios() {
    usuarios.forEach(usuario => {
      ...
      row.innerHTML = `
        ...
        <td>
          <a class="link-accion ${usuario.estado === 'Activo' ? 'link-rojo' : 'link-verde'}">${usuario.estado === 'Activo' ? 'Bloquear' : 'Activar'}</a>
          <a class="link-accion actualizar-usuario">Actualizar</a>
