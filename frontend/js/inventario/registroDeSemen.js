document.addEventListener('change', function (event) {
 ...
 addUserButton.addEventListener('click', function () {
   ...
   newRow.innerHTML = `
              ...
              <td>
                <input type="date" class="input-no-border fecha-recoleccion" placeholder="Fecha de Recolección">
              </td>
              <td>
              ...
              <td>
                <input type="date" class="input-no-border fecha-caducidad" placeholder="Fecha de caducidad">
              </td>
                <td>
                    <input type="date" class="input-no-border fecha-salida" placeholder="Fecha de salida">
              <td>
              ...
              <td>
                <span class="estado-semen"></span> <!-- Cambia el texto según el estado -->
              </td>
   `;
 ...
 deleteUserButton.addEventListener('click', function () {
  ...
  document.getElementById('exportExcelButton').addEventListener('click', function (event) {
    ...
    worksheetData.push(['Seleccionar', 'ID-Verraco', 'Fecha de Recolección', 'Cantidad', 'Calidad-Semen','Fecha de caducidad', 'Fecha de Salida', 'Responsable', 'Solicitante', 'Estado']);
