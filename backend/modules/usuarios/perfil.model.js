...
const actualizarPerfil = (id, { nombre, telefono, password, foto, cargo, permiso }) => {
...
// (No se requieren cambios en este archivo si el campo foto es tipo TEXT o similar en la base de datos.)
